...
import via.winmall.lueorganisation.adapter.PagerNewsTabDetails;
...
public class NewsActivity extends AppCompatActivity implements TabLayout.OnTabSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PagerNewsTabDetails adapter=new PagerNewsTabDetails(getSupportFragmentManager(),tablayout.getTabCount());
